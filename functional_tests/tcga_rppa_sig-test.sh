...
this_program_name="tcga_rppa_sig-test.sh"
...
${this_program_name}: run integration/regression tests for tcga_rppa_sig 

Usage:
    ${this_program_name} [-h] [-v] -p program -d test_data_dir 

Example:
    ${this_program_name} -p bin/tcga_rppa_sig -d data/tests
